...
<body>
<p>La/les s�ance/s que vous avez choisi</p>
        ...
        <div class="card card-profile shadow mt--300">
          <div class="px-4">
            ...
            <div class="text-center mt-5">
              <h1>Liste des s�ances choisis</h1>
              <p> <% String[] listeSeancesChoisies = (String[]) session.getAttribute("listeSeancesChoisies");
					List<String>  MyList = (List<String>) Arrays.asList(listeSeancesChoisies);
					HashMap<Seance, String> listeSeances = (HashMap<Seance, String>)session.getAttribute("listeSeances");
				...
				%>
				<a href="deposer.jsp"><input type="button" value = "Confirmer"/></a>
				<button onclick="history.back()">Retour aux choix</button> 
			</p>
            </div>
