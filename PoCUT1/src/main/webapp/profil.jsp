...
<h2>Informations suppl�mentaire</h2>
<table>
		<tr>
        ...
        <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a href="CtrlAbsJus" class="dropdown-item">Absences justifi�es</a>
              <a href="CtrlConnexion" class="dropdown-item">Absences non-justifi�es</a>
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          ...
          <li class="nav-item d-none d-lg-block">
            <a href="CtrlDeconnexion" target="_blank" class="btn btn-neutral btn-icon">
              ...
              <span class="nav-link-inner--text"> D�connexion </span>
            </a>
          </li>
        </ul>
      </div>
    ...
    <section class="section bg-secondary">
      <div class="container">
		...
		<tr>
			<td>Nom</td>
			<td><%String nom = (String)session.getAttribute("nom");
				out.print("<p class='p'>"+nom+"</p>");%></td>
		</tr>

		<tr>
			<td>Prenom</td>
			<td><%String prenom = (String)session.getAttribute("prenom");
				out.print("<p class='p'>"+prenom+"</p>");%></td>
		</tr>

		<tr>
			<td>Adresse email</td>
			<td><%String email = (String)session.getAttribute("email");
				out.print("<p class='p'>"+email+"</p>");%></td>
		</tr>
		...
		<tr>
			...
			<td><%
				String formation = (String) request.getAttribute("formation");
				out.print("<p class='p'>"+formation+"</p>");%></td>
		</tr>
		
</table>
<h3>Informations suppl�mentaire</h3>
<table>
		<tr>
			<td>Num�ro de t�l�phone</td>
			<td><%
				String tele = (String) request.getAttribute("tele");
				out.print("<p class='p'>"+tele+"</p>");%></td>
		</tr>
		...
		<tr>
			...
			<td><%
				String adresse = (String) request.getAttribute("adresse");
				out.print("<p class='p'>"+adresse+"</p>");%></td>
		</tr>
</table>
